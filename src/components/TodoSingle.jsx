...
export default function TodoItemSingle({ data }) {
...
// }
  ...
  return (
    <Card sx={{ maxWidth:400, margin: "auto", boxShadow: '3px 3px 10px teal' }}
      ...
      <CardContent>
        ...
        <Typography sx={{ mb: 1.5 }} color="text.secondary" variant="h6">
          {data.status===true ?<div style={{color:'green',textDecoration:'line-through'}}>Completed</div> : <div style={{color:'red'}}>Not Completed</div>}
              ...
              <Typography sx={{fontSize:'14px'}} variant="h6" component="div">
                  {/* <Link to={`/tasks/${data.id}`}>View Task</Link> */}
              <em>You can Toggle or Delete the task by going in All Tasks Section</em>     
        </Typography>
